...
// 	console.log(triangulo + ' é True');
// } else {
// 	console.log(triangulo + ' é False');
// }
...
// let peça = peçaXadrez.toLowerCase();
...
// let lucroX1000 = lucro * 1000;

// if (custo < 0 || venda < 0){
// 	console.log('Erro Catastrófico');
// } else {
//  	console.log('o lucro desta empresa é R$ ' + lucro + ', e ao vender mil produtos é R$ ' + lucroX1000 + '.' );
// }

//-----------------------------------------

// Questão 11 = Uma pessoa que trabalha de carteira assinada no Brasil tem descontados de seu salário bruto o INSS e o IR. Faça um programa que, dado um salário bruto, calcule o líquido a ser recebido.
...
// } else if (salarioBruto >= 1556.95 && salarioBruto <= 2594.94){
...
// let salarioAliquota = salarioBruto - aliquota;
// let ir;
// let salarioIr;

// if (salarioAliquota < 1903.98){
//     salarioIr = salarioAliquota;
// } else if ( salarioAliquota >= 1903.99 && salarioAliquota <= 2826.65 ){
//     ir = salarioAliquota * 0.075 - 142.80;
// } else if ( salarioAliquota >= 2826.66 && salarioAliquota <= 3751.05 ){
//     ir = salarioAliquota * 0.15 - 354.80;
// } else if ( salarioAliquota >= 3751.06 && salarioAliquota <= 4664.68 ){
//     ir = salarioAliquota * 0.225 - 636.13; 
// } else if (salarioAliquota >= 4664.69){
//     ir = salarioAliquota * 0.275 - 869.36;
// }
 
//     salarioIr = salarioAliquota - ir; 

// console.log('O salário bruto menos imposto de renda e inss é = ' + salarioIr);
