...
SELECT * FROM Scientists ORDER BY Name DESC;
...
SELECT CONCAT('Existem ', COUNT(Name), ' cientistas na tabela Scientists.') AS 'Numero de Cientistas' FROM Scientists.Scientists;
